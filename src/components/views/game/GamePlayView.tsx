...
import global from '../../../modules/draw/context/GlobalContext';
...
export function GamePlayView({
  ...
  const onContextChanged = useCallback((contextObject:CanvasContextObject) => {
  ...
  return (
    <>
      ...
      {gameDraw && <DefaultGameView {...gameViewProps} onContextChanged={onContextChanged} />}
    </>
  );
}